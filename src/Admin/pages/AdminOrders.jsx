    ...
    <>
      <div className='grid grid-cols-5'>
        ...
        <div className='col-span-4 p-10 pt-16 lg:p-8 lg:pt-10 bg-gray-100 min-h-screen'>
          <h1 className='text-4xl font-bold text-gray-700'>Order Management</h1>
          <p className='mt-2 text-lg text-gray-500 font-medium'>Track and manage active orders</p>
          ...
          <div className='md:flex justify-center items-center mt-15 gap-4 hidden '>
            ...
            <div style={{ width: "350px", height: "100px" }} className=' shadow-2xl shadow-gray-200 rounded-xl bg-white p-6 flex gap-5'>
              <div className='flex justify-center items-center bg-gray-100 p-3 rounded-xl'>
                <GoHistory className='text-4xl text-gray-500' />
              </div>
              <div>
                <h2 className='text-1xl'>Pending</h2>
            ...
            <div style={{ width: "350px", height: "100px" }} className=' shadow-2xl shadow-gray-200 rounded-xl bg-white p-6 flex gap-5'>
              <div className='flex justify-center items-center bg-green-100 p-3 rounded-xl'>
                <IoMdCheckmarkCircleOutline className='text-4xl text-green-500' />
              </div>
              <div>
                <h2 className='text-1xl'>confirmed</h2>
            ...
            <div style={{ width: "350px", height: "100px" }} className=' shadow-2xl shadow-gray-200 rounded-xl bg-white p-6 flex gap-5'>
              <div className='flex justify-center items-center bg-orange-100 p-3 rounded-xl'>
                <PiChefHatLight className='text-4xl text-orange-500' />
              </div>
              <div>
                <h2 className='text-1xl'>Preparing</h2>
                <p className='text-3xl font-bold'>1</p>
              </div>
            ...
            <div style={{ width: "350px", height: "100px" }} className=' shadow-2xl shadow-gray-200 rounded-xl bg-white p-6 flex gap-5'>
              <div className='flex justify-center items-center bg-green-100 p-3 rounded-xl'>
                <IoBagCheckOutline className='text-4xl text-green-500' />
              </div>
              <div>
                <h2 className='text-1xl'>ready</h2>
                <p className='text-3xl font-bold'>1</p>
              </div>
